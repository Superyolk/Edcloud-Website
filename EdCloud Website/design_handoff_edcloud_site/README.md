...
- **03 By The Numbers**: grid `repeat(auto-fit,minmax(220px,1fr)); gap:24px`; white cards, card shadow, `padding:32px; gap:8px`: stat 48px green (`22`, `14`, `2`, `8`), H3 20px (`Years of Experience`, `Ongoing Projects`, `Provisional Patents`, `Talented Employees`), description 15px/1.5.
