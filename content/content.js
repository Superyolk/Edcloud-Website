...
const logos = [
      ...
      // closed; each one is now a local WebP sized for the ~99x27 box it renders in.
      { src: '/images/logos/client-40.webp', alt: 'Client logo' },
      { src: '/images/logos/client-37.webp', alt: 'Client logo' },
      { src: '/images/logos/client-02.webp', alt: 'Client logo' },
      { src: '/images/logos/lausd.webp', alt: 'LAUSD' },
      { src: '/images/logos/project-wayfinder.webp', alt: 'Project Wayfinder' },
      { src: '/images/logos/reach-capital.webp', alt: 'Reach Capital' },
      { src: '/images/logos/tutorme.webp', alt: 'TutorMe' },
      { src: '/images/logos/green-dot.webp', alt: 'Green Dot' },
      { src: '/images/logos/edthena.webp', alt: 'Edthena' },
      { src: '/images/logos/amplify.webp', alt: 'Amplify' },
      { src: '/images/logos/client-15.webp', alt: 'Client logo' },
      { src: '/images/logos/client-24.webp', alt: 'Client logo' },
      { src: '/images/logos/booknook.webp', alt: 'BookNook' },
      { src: '/images/logos/everfi.webp', alt: 'EVERFI' },
      { src: '/images/logos/client-06.webp', alt: 'Client logo' },
      { src: '/images/logos/tcsa.webp', alt: 'TCSA' },
      { src: '/images/logos/client-16.webp', alt: 'Client logo' },
      { src: '/images/logos/berkeley-city-college.webp', alt: 'Berkeley City College' },
      { src: '/images/logos/client-20.webp', alt: 'Client logo' },
      { src: '/images/logos/emerson-collective.webp', alt: 'Emerson Collective' },
      { src: '/images/logos/bullseye.webp', alt: 'Bullseye' },
      { src: '/images/logos/lindsay-leads.webp', alt: 'Lindsay Leads' },
      { src: '/images/logos/classavo.webp', alt: 'Classavo' },
      { src: '/images/logos/youth-radio.webp', alt: 'Youth Radio' },
      { src: '/images/logos/client-21.webp', alt: 'Client logo' },
      { src: '/images/logos/hgp.webp', alt: 'HGP' },
      { src: '/images/logos/client-11.webp', alt: 'Client logo' },
      { src: '/images/logos/sfusd.webp', alt: 'SFUSD' },
      { src: '/images/logos/ousd.webp', alt: 'OUSD' },
      { src: '/images/logos/client-08.webp', alt: 'Client logo' },
      { src: '/images/logos/nyu.webp', alt: 'NYU' },
      { src: '/images/logos/client-14.webp', alt: 'Client logo' },
      { src: '/images/logos/pearson.webp', alt: 'Pearson' },
      { src: '/images/logos/cfund.webp', alt: 'CFund' },
      { src: '/images/logos/client-33.webp', alt: 'Client logo' },
      { src: '/images/logos/client-04.webp', alt: 'Client logo' },
      { src: '/images/logos/client-05.webp', alt: 'Client logo' },
      { src: '/images/logos/client-26.webp', alt: 'Client logo' },
      { src: '/images/logos/client-39.webp', alt: 'Client logo' },
      { src: '/images/logos/edvisorly.webp', alt: 'EdVisorly' },
      { src: '/images/logos/client-34.webp', alt: 'Client logo' },
      { src: '/images/logos/teachfx.webp', alt: 'TeachFX' },
      { src: '/images/logos/client-31.webp', alt: 'Client logo' },
      { src: '/images/logos/newschools-venture-fund.webp', alt: 'NewSchools Venture Fund' },
      { src: '/images/logos/lumi.webp', alt: 'Lumi' },
      { src: '/images/logos/marble.webp', alt: 'Marble' },
      { src: '/images/logos/worksheets-ai.webp', alt: 'Worksheets AI' },
      { src: '/images/ucsd-logo.png', alt: 'UC San Diego' }
    ];
    const press = [
